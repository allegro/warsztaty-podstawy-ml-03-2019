...
def dump_as_vector(mobs, player, bullets, pygame, frame_no):
    state = []
    keystate = pygame.key.get_pressed()
...
while running:
    ...
    # dump_human_readeable_state(all_sprites, pygame)
    dump_as_vector(mobs, player, bullets, pygame, frame_counter)
